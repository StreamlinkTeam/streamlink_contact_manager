...
import cl.streamlink.contact.service.ContractHistoryService;
...
public class ContractController {
        ...
        public ContractDTO getContract(@RequestParam(value = "developerReference") String developerReference)
                        throws ContactApiException {
        ...
        public JSONObject deleteContract(@RequestParam("developerReference") String developerReference)
                        throws ContactApiException {

                return contractService.deleteContract(developerReference);
        }

        @RequestMapping(value = "wished", method = RequestMethod.PUT, produces = MediaType.APPLICATION_JSON_VALUE)
        @ResponseStatus(HttpStatus.OK)
        ...
        @RequestMapping(value = "wished", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
        @ResponseStatus(HttpStatus.OK)
        ...
        public WishedContractDTO getWishedContract(
                        @RequestParam(value = "developerReference") String developerReference) {
        ...
        @ResponseStatus(HttpStatus.OK)
        @ApiOperation(value = "Get Developer Contract history Details Service")
        @ApiResponses(value = {
                        @ApiResponse(code = 200, message = "Operation Executed Successfully", response = ContractDTO.class),
                        @ApiResponse(code = 404, message = "Contract with Ref not Found")
        })
        public List<ContractHistory> getContractHistory(
                        @RequestParam(value = "developerReference") String developerReference)
                        throws ContactApiException {
                return contractHistoryService.getContractHistory(developerReference);
        }
