...
public class MessageFactory {
    ...
    public static String getMessage(String s, Object[] objects, String lang) {
        ...
        try {
            ...
            try {
                ...
                return messageSource.getMessage("developer.api.exception.thrown", null, lang != null ? new Locale(lang) : getLocalFromHeader());
            }
        }
    }
    ...
    public static String getObjectLabel(Object object) {
        try {
            return messageSource.getMessage("developer.api.label." + String.valueOf(object).toLowerCase(), null, getLocalFromHeader());
        } catch (NoSuchMessageException ex) {
